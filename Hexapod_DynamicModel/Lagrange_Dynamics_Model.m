...
V1_1 = simplify(F1 - (M1_1*A_Theta1+M1_2*A_Theta2+M1_3*A_Theta3) - G1_1);
V2_1 = simplify(F2 - (M2_1*A_Theta1+M2_2*A_Theta2+M2_3*A_Theta3) - G2_1);
V3_1 = simplify(F3 - (M3_1*A_Theta1+M3_2*A_Theta2+M3_3*A_Theta3) - G3_1);
...
% 保存计算结果
% save('M_theta.mat','M_theta');
% save('V_theta_wtheta.mat','V_theta_wtheta');
% save('G_theta.mat','G_theta');
